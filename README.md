...
## References
- ObserableObjects to create a controller that holds the view state, instead of view handling this - https://developer.apple.com/documentation/combine/observableobject
